...
class Gapps(General):
    dl_links = {
            ...
            "arm64-v8a": ["https://cyfuture.dl.sourceforge.net/project/opengapps/arm64/20220503/open_gapps-arm64-10.0-pico-20220503.zip?viasf=1", "2feaf25d03530892c6146687ffa08bc2"],
